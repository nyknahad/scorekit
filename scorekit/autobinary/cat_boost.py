...
from .utils import TransformerWithTargetMixin, convert_input, convert_input_vector, get_obj_cols, convert_cols_to_list, get_generated_cols
from sklearn.utils.random import check_random_state

__author__ = 'Jan Motl'


class CatBoostEncoder(BaseEstimator, TransformerWithTargetMixin):
    ...
    def fit(self, X, y, **kwargs):
        ...
        X = convert_input(X)
        y = convert_input_vector(y, X.index).astype(float)
